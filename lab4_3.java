public class lab4_3 {
    ...
    public lab4_3(int id, int passengers, int fuelCap, int mpg) {
        this.id = id;
    ...
    // Other object doesn't care how lab4_3's range() method calculates
    // the range of a vehicle. They don't care how many variables a
    // lab4_3 object has. These are implementation details of a
    ...
    public static void main(String[] args) {
        lab4_3 v1 = new lab4_3(1, 4, 17, 25);
        int range = v1.range();
