public class lab4_1 {
    ...
    void range() { // use class variable without dot operator within class method.
    ...
    static lab4_1 passByValue(int i, lab4_1 v) {
    ...
    // My test program for class lab4_1
    public static void main(String[] args)
    {
        ...
        System.out.println("You can access a class variable, or class method withoutinstantiating an object");
        System.out.println("Access class variable using dot operator: lab4_1.hasEngine=" + lab4_1.hasEngine);
        System.out.println("Access class method using dot operator:");
        int range1 = lab4_1.calcRange(18,33);
        System.out.println("lab4_1.calcRange(18,33)="+range1);
        ...
        //Instantiate a second lab4_1 object
        System.out.println("\nInstantiate a second vehicle object");
        lab4_1 sedan = new lab4_1();//create a second object
        sedan.passengers = 4;
        sedan.fuelcap = 10;
        sedan.mpg = 35;
        ...
        v.mpg = 12;
        v = minivan;
        //now v reference the memory block where minivan
        //object reference to.
